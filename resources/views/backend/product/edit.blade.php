    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
            ...
            <input  id="inputTitle" type="text" name="title_ar"  value="{{$product->title_ar}}" class="form-control text-right">
            @error('title_ar')
            <span class="text-danger">{{$message}}</span>
            @enderror
          </div>
        ...
        <div class="form-group">
            ...
            <textarea  class="form-control" id="summary_ar" name="summary_ar">{{$product->summary_ar}}</textarea>
            @error('summary_ar')
            <span class="text-danger">{{$message}}</span>
            @enderror
          </div>
        ...
        <div class="form-group">
            ...
            <textarea  class="form-control" id="description_ar" name="description_ar">{{$product->description_ar}}</textarea>
