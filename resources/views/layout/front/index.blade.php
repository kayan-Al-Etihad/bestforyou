                                                                    ...
                                                                    <ul id="menu-primary-menu" class="flytheme_resmenu">
                                                                        <li class="res-dropdown menu-shop">
                                                                            <a class="item-link dropdown-toggle"
                                                                                href="{{ route('home') }}">@lang('auth.nan_link_home')</a>
                                                                        </li>
                                                                        <li class="res-dropdown menu-shop">
                                                                            <a class="item-link dropdown-toggle"
                                                                                href="/products">@lang('auth.nan_link_shop')</a>
                                                                        </li>
                                                                        <li class="res-dropdown menu-shop">
                                                                            <a class="item-link dropdown-toggle"
                                                                                href="{{ route('front.categories') }}">@lang('auth.nan_link_categories')</a>
                                                                        </li>
                                                                        <li class="res-dropdown menu-shop">
                                                                            <a class="item-link dropdown-toggle"
                                                                                href="{{ route('about.index') }}">@lang('auth.nan_link_about')</a>
                                                                        </li>
                                                                        <li class="res-dropdown menu-shop">
                                                                            <a class="item-link dropdown-toggle"
                                                                                href="{{ route('contact.index') }}">@lang('auth.nan_link_contact_us')</a>
                                                                        </li>
                                                                        <li class="res-dropdown menu-shop">
                                                                            <a class="item-link dropdown-toggle"
                                                                                href="{{ route('franchise.index') }}">@lang('auth.nan_link_franchise')</a>
                                                                        </li>
                                                                        <li class="res-dropdown menu-shop">
                                                                            <a class="item-link dropdown-toggle"
                                                                                href="{{ route('join-us.index') }}">@lang('auth.nan_link_join_us')</a>
                                                                        </li>
                                                            ...
                                                            <ul id="menu-primary-menu-1"
                                                                ...
                                                                <li class=" menu-shop ya-mega-menu level1">
                                                                    <a href="{{ route('about.index') }}"
                                                                        ...
                                                                        <span class="have-title">
                                                                            <span
                                                                                class="menu-title">@lang('auth.nan_link_about')</span>
                                                                        </span>
                                                                    </a>
                                                                </li>
                                                                <li class=" menu-shop ya-mega-menu level1">
                                                                    <a href="{{ route('front.categories') }}"
                                                                        ...
                                                                        <span class="have-title">
                                                                            <span
                                                                                class="menu-title">@lang('auth.categories')</span>
                                                                        </span>
                                                                    </a>
                                                                </li>
                                                                <li class=" menu-shop ya-mega-menu level1">
                                                                    <a href="/products" class="item-link">
                                                                        <span class="have-title">
                                                                            <span
                                                                                class="menu-title">@lang('auth.nan_link_shop')</span>
                                                                        </span>
                                                                    </a>
                                                                </li>
                                                                <li class="menu-portfolios ya-menu-custom level1">
                                                                    <a href="{{ route('home') }}" class="item-link">
                                                                        <span class="have-title">
                                                                            <span
                                                                                class="menu-title">@lang('auth.nan_link_home')</span>
                                                                        </span>
                                                                    </a>
                                                                </li>
