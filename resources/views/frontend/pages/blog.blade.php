                    ...
                    @if (app()->getLocale() == "ar")
                        <div class="bread-inner text-right" dir="rtl">
                            <ul class="bread-list">
                                ...
                                <li class="active"><a href="{{ route('product-grids') }}">@lang('auth.blog')</a></li>
                            </ul>
                        </div>
                    @else
                        <div class="bread-inner">
                            <ul class="bread-list">
                                ...
                                <li class="active"><a href="{{ route('blog') }}">@lang('auth.blog')</a></li>
                            </ul>
                        </div>
                    @endif
                </div>
                        ...
                        <div class="main-sidebar">
                            ...
                            <div class="single-widget search">
                                <form class="form" method="GET" action="{{route('blog.search')}}">
                                    <input dir="rtl" type="text" class="text-right" placeholder="@lang('auth.search')" name="search">
                            ...
                            <div class="single-widget category">
                                <h3 class="title">@lang('auth.blog_categories')</h3>
                            ...
                            <div class="single-widget side-tags">
                                <h3 class="title">@lang('auth.tags')</h3>
                                <ul class="tag">
                                    @if(!empty($_GET['tag']))
                                        @php
