                                    ...
                                    <div class="shop-top">
                                        <div class="shop-shorter">
                                            ...
                                            <div class="single-shorter">
                                                ...
                                                <label class="text-right" style="padding-left: 10px !important">@lang('auth.Show') : </label>
                                            </div>
                                            <div class="single-shorter">
                                                ...
                                                <label class="text-right" style="padding-left: 10px !important">@lang('auth.sort_by') : </label>
                                            </div>
                                        </div>
                                        <ul class="view-mode">
                                                @if (url()->current() == "http://127.0.0.1:8000/product-lists")
